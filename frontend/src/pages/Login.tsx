    ...
    <div className="min-h-screen bg-page flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-fg3 mt-1">{t.login.subtitle}</p>
        </div>

        {/* Card */}
        <div className="card shadow-xl" style={{ boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }}>
          <h2 className="text-lg font-bold text-fg mb-6">{t.login.title}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" className="input-field" placeholder={t.login.ph_password}
